...
class JointEstimator:
  ...
  def calculate_angles(self):
    ...
    link3 = j4 - j3
    link4 = j4 - j2
    #arctan2 - location of yellow C1 0 - location of green C1 0 , location of yellow c1 1 - location of yellow c1 1
    #a2 = np.arctan2(j2[2] - j3[2], self.joints1[1][0] - self.joints1[2][0]) - (np.pi/2)
